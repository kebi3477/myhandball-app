    ...
    GuideLesson(
      ...
      steps: [
        ...
        GuideStep(
          ...
          title: '골키퍼는 마지막 방패',
          body: '골키퍼는 골 에어리어 안에서 발까지 온몸을 써서 막을 수 있어요. '
              '선방률 30%를 넘기면 수준급!',
        ),
      ],
      quiz: GuideQuiz(
        question: '7m 드로는 언제 주어질까요?',
        options: ['공이 코트 밖으로 나가면', '득점 기회를 반칙으로 막으면', '골키퍼가 공을 잡으면'],
        answerIndex: 1,
    ...
    GuideLesson(
      ...
      steps: [
        GuideStep(
          ...
          title: '경고 → 2분 퇴장 → 실격',
          body: '가벼운 반칙은 옐로카드 경고, 반복되거나 위험하면 2분 퇴장, '
              '아주 심하면 레드카드로 실격돼요.',
        ),
        GuideStep(
          scene: GuideScene.twoMinutes,
          title: '2분 동안 한 명 적게',
          body: '2분 퇴장을 받으면 그동안 팀은 한 명이 적은 채로 싸워야 해요. '
              '경기 흐름이 확 바뀌는 순간이에요!',
        ),
      ],
      quiz: GuideQuiz(
        question: '2분 퇴장을 받으면 팀은 어떻게 될까요?',
        options: ['인원 그대로 경기', '2분간 한 명 적게', '끝까지 한 명 적게'],
        answerIndex: 1,
